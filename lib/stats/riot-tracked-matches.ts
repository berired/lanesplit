 ...
 * must already know which match IDs to query, and there's no live feed of
 * pro-team matches from the official Riot API. For champion-mode leagues, a
 * commissioner is expected to populate this list with the match IDs
 * (region-prefixed, e.g. "NA1_4567890123") whose stats should be pulled in on
 * the next periodic Riot sync.
 *
